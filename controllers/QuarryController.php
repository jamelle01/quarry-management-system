<?php
require_once 'models/QuarryModel.php';

class QuarryController
{
    private $model;

    public function __construct(QuarryModel $model)
    {
        $this->model = $model;
    }
    ...
    public function view($Quarry_Permit_Key)
    {
        $data = $this->model->getPermitteeById($Quarry_Permit_Key);
        require 'views/view_quarry.php';
    }

    public function edit($Quarry_Permit_Key)
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $this->model->updatePermittee($Quarry_Permit_Key, $Permittee_Name, $Tin_No, $Postal_Address, $Extraction_Site, $Type_of_Mineral, $Permit_No, $Approved_Volume, $Area, $Date_Approved, $Expiry_Date);

            // print "<pre/> view";
            // exit();
            // header('Location: views/ui_quarry_permittee.php');
            // require 'views/ui_quarry_permittee.php';
            $this->getPermittees();
    ...
    public function create()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            require 'views/create_quarry.php';
        }
    }
