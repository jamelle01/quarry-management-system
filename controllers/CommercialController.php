<?php
require_once 'models/CommercialModel.php';

class CommercialController
{
    private $model;

    public function __construct(CommercialModel $model)
    {
        $this->model = $model;
    }
    ...
    public function getPermittees()
    {
        ...
        require 'views/ui_commercial_permittee.php';
    }

    public function view($Commercial_Permit_Key)
    {
        $data = $this->model->getPermitteeById($Commercial_Permit_Key);
        require 'views/view_commercial.php';
    }

    public function edit($Commercial_Permit_Key)
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $this->model->updatePermittee($Commercial_Permit_Key, $Permittee_Name, $Tin_No, $Postal_Address, $Extraction_Site, $Type_of_Mineral, $Permit_No, $Approved_Volume, $Area, $Date_Approved, $Expiry_Date);

            // print "<pre/> view";
            // exit();
            // header('Location: views/ui_commercial_permittee.php');
            // require 'views/ui_commercial_permittee.php';
            $this->getPermittees();

        } else {
            $data = $this->model->getPermitteeById($Commercial_Permit_Key);
            require 'views/edit_commercial.php';
        }
    }
    ...
    public function create()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            require 'views/create_commercial.php';
        }
    }
